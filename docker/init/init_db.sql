...
CREATE TABLE IF NOT EXISTS admin_user (
	...
	timestamp TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP NOT NULL,
	registered_user_id BIGINT NOT NULL UNIQUE REFERENCES registered_user(registered_user_id),
	ip_id BIGINT REFERENCES ip_address(ip_id) NOT NULL,
...
-- Create the two people entries here, this could be an enum instead
INSERT INTO
	meal_person (person)
VALUES
	('Dave'),
