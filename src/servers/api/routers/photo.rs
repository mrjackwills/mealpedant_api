...
mod tests {
    ...
    use crate::servers::api_tests::{Response, base_url, start_both_servers};
    ...
    #[tokio::test]
    /// Photo can be uploaded and converted correctly
    async fn api_router_photo_post_ok() {
        ...
        let original_name = PathBuf::from(
            format!(
                "{}/{}/{}/{}",
                test_setup.app_env.location.photo_original,
        ...
        let converted_name = PathBuf::from(
            format!(
                "{}/{}/{}/{}",
                test_setup.app_env.location.photo_converted,
    ...
    async fn api_router_photo_delete_ok() {
        ...
        let original_path = format!(
            "{}/{}",
            test_setup.app_env.location.photo_original, original
        );
        let converted_path = format!(
            "{}/{}",
            test_setup.app_env.location.photo_converted, converted
        );
